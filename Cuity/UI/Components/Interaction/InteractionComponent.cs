...
public class InteractionComponent: IComponent {
    ...
    public InteractionComponent(Action<InputMessage> onInput) 
        => WorkerSystem.Current.AddInputCallback(work: onInput);
    ...
    public InteractionComponent(Action<RenderMessage> onRender)
        => WorkerSystem.Current.AddRenderCallback(work: onRender);
}
